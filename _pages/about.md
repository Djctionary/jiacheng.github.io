...
I am currently looking for Ph.D. positions starting Fall 2026. You can check my CV here: {% assign cv_path = "/docs/Jiacheng Dong's CV(English).pdf" | replace: " ", "%20" | replace: "(", "%28" | replace: ")", "%29" | replace: "'", "%27" %}[📄 CV]({{ cv_path | relative_url }})
